...
var css_248z$1 = ".updpat-search-icon-image {\n  height: 16px;\n}";
...
function UpdaptInput(_a) {
  var type = _a.type,
    ...
    width = _a.width,
    value = _a.value,
    rest = __rest(_a, ["type", "isError", "width", "value"]);
  return reactExports.createElement(reactExports.Fragment, null, reactExports.createElement("input", __assign({
    className: value || isError ? "updapt-input-filled ".concat(isError ? "error" : "no-error") : "updapt-input-not-filled",
    style: {
...
function UpdaptSearchInput(_a) {
    var width = _a.width;
    return (reactExports$1.createElement(reactExports$1.Fragment, null,
        reactExports$1.createElement("img", { src: images.SearchIcon, alt: "Search Icon", className: "updpat-search-icon-image" }),
        reactExports$1.createElement(UpdaptInput, { type: "search", width: width })));
}
